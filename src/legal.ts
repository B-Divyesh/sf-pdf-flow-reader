...
root.innerHTML = privacy ? `
  <header class="site-header"><a class="brand" href="/"><img src="/assets/icon.svg" width="36" height="36" alt=""><span>PDF FLOW READER</span></a></header>
...
document.body.insertAdjacentHTML('beforeend', '<footer class="site-footer"><a href="/">Reader</a><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a><span>Files stay on this device.</span></footer>');

...
- [Try it with sample data](https://pdf-flow-reader.sociobot.in/?demo=1) before opening your own PDF.
...
- Save your reading place and settings in this browser; export, import, or erase that local library.
- Reload offline after the first visit.

Scanned/image-only PDFs need OCR and are reported as unsupported. Check the source PDF for tables, equations, columns, and footnotes. Owner restrictions on text copying are respected.
